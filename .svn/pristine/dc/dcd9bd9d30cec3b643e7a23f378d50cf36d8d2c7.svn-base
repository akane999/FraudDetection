...
public class Adq_presente {
    ...
    public Map<String, String> evaluar(Instances data) throws ClassNotFoundException, Exception{
       ...
       // System.out.println(data);
		...
		String rutaC1 = 		System.getProperty( "modelo.adquiriente.presente.c1" , "./weka-modelo/adquiriente/Presente/FUZZY_ROUGH_NN.model" );
		String rutaC2 = 		System.getProperty( "modelo.adquiriente.presente.c2" , "./weka-modelo/adquiriente/Presente/J48.model" );
		String rutaC3 =			System.getProperty( "modelo.adquiriente.presente.c3" , "./weka-modelo/adquiriente/Presente/JRip.model" );
		String rutaC4 = 		System.getProperty( "modelo.adquiriente.presente.c4" , "./weka-modelo/adquiriente/Presente/NAIVE_BAYES.model" );
		
		System.out.println( "============================" );
		System.out.println( "  Rutas modelo Adquirente presente " );
		System.out.println( "============================" );
